          ...
          ================================================= -->
            ...
            <div id="chat-block">
              ...
              <ul class="online-users list-inline">
                <li><a href="message" title="Linda Lohan"><img src="<?php echo $this->url;?>images/users/user-2.jpg" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="message" title="Sophia Lee"><img src="<?php echo $this->url;?>images/users/user-3.jpg" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="message" title="John Doe"><img src="<?php echo $this->url;?>images/users/user-4.jpg" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="message" title="Alexis Clark"><img src="<?php echo $this->url;?>images/users/user-5.jpg" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="message" title="James Carter"><img src="<?php echo $this->url;?>images/users/user-6.jpg" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="message" title="Robert Cook"><img src="<?php echo $this->url;?>images/users/user-7.jpg" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="message" title="Richard Bell"><img src="<?php echo $this->url;?>images/users/user-8.jpg" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="message" title="Anna Young"><img src="<?php echo $this->url;?>images/users/user-9.jpg" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="message" title="Julia Cox"><img src="<?php echo $this->url;?>images/users/user-10.jpg" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
              </ul>
            </div><!--chat block ends-->
          </div>
    			<div class="col-md-7">
            ...
            <div class="media">
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-1">
                      <img src="<?php echo $this->url;?>images/post-images/6.jpg" alt="" class="img-responsive post-image" />
                    </div>
                    <div class="media-info">
                      ...
                      <div class="user-info">
                        <img src="<?php echo $this->url;?>images/users/user-8.jpg" alt="" class="profile-photo-sm pull-left" />
                        <div class="user">
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="post-content">
                            <img src="<?php echo $this->url;?>images/post-images/1.jpg" alt="post-image" class="img-responsive post-image" />
                            <div class="post-container">
                              <img src="<?php echo $this->url;?>images/users/user-5.jpg" alt="user" class="profile-photo-md pull-left" />
                              <div class="post-detail">
                                ...
                                <div class="reaction">
                                  <a class="btn text-green"><i class="icon ion-thumbsup"></i> 130</a>
                                ...
                                <div class="post-comment">
                                  <img src="<?php echo $this->url;?>images/users/user-11.jpg" alt="" class="profile-photo-sm" />
                                  <p><a href="timeline.html" class="profile-link">Diana </a><i class="em em-laughing"></i> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud </p>
                                </div>
                                <div class="post-comment">
                                  <img src="<?php echo $this->url;?>images/users/user-4.jpg" alt="" class="profile-photo-sm" />
                                  <p><a href="timeline.html" class="profile-link">John</a> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud </p>
                                </div>
                                <div class="post-comment">
                                  <img src="<?php echo $this->url;?>images/users/user-1.jpg" alt="" class="profile-photo-sm" />
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-2">
                      <img src="<?php echo $this->url;?>images/post-images/3.jpg" alt="" class="img-responsive post-image" />
                    </div>
                    <div class="media-info">
                      <div class="reaction">
                      ...
                      <div class="user-info">
                        <img src="<?php echo $this->url;?>images/users/user-5.jpg" alt="" class="profile-photo-sm pull-left" />
                        <div class="user">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-3">
                      <img src="<?php echo $this->url;?>images/post-images/5.jpg" alt="" class="img-responsive post-image" />
                    </div>
                    <div class="media-info">
                      <div class="reaction">
                      ...
                      <div class="user-info">
                        <img src="<?php echo $this->url;?>images/users/user-7.jpg" alt="" class="profile-photo-sm pull-left" />
                        <div class="user">
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-4">
                      <img src="<?php echo $this->url;?>images/post-images/2.jpg" alt="" class="img-responsive post-image" />
                    </div>
                    <div class="media-info">
                      <div class="reaction">
                      ...
                      <div class="user-info">
                        <img src="<?php echo $this->url;?>images/users/user-4.jpg" alt="" class="profile-photo-sm pull-left" />
                        <div class="user">
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-5">
                      <img src="<?php echo $this->url;?>images/post-images/4.jpg" alt="" class="img-responsive post-image" />
                    </div>
                    <div class="media-info">
                      <div class="reaction">
                      ...
                      <div class="user-info">
                        <img src="<?php echo $this->url;?>images/users/user-3.jpg" alt="" class="profile-photo-sm pull-left" />
                        <div class="user">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-6">
                      <img src="<?php echo $this->url;?>images/post-images/7.jpg" alt="" class="img-responsive post-image" />
                    </div>
                    <div class="media-info">
                      <div class="reaction">
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-7">
                      <img src="<?php echo $this->url;?>images/post-images/1.jpg" alt="" class="img-responsive post-image" />
                    </div>
                    <div class="media-info">
                      <div class="reaction">
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-8">
                      <img src="<?php echo $this->url;?>images/post-images/9.jpg" alt="" class="img-responsive post-image" />
                    </div>
                    <div class="media-info">
                      <div class="reaction">
                      ...
                      <div class="user-info">
                        <img src="<?php echo $this->url;?>images/users/user-2.jpg" alt="" class="profile-photo-sm pull-left" />
                        <div class="user">
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-9">
                      <img src="<?php echo $this->url;?>images/post-images/8.jpg" alt="" class="img-responsive post-image" />
                    </div>
                    <div class="media-info">
                      <div class="reaction">
