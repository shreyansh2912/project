    	...
    	<div class="container">
          ...
          <div class="col-md-3 static">
            <div class="profile-card">
            	...
            	<a href="#" class="text-white"><i class="ion ion-android-person-add"></i> 5,399 followers</a>
            ...
            <div class="post-content">
							<div class="video-wrapper">
								<video class="post-video" controls> <source src="<?php echo $this->url;?>videos/8.mp4" type="video/mp4"> </video>
						  </div>
              <div class="post-container">
                <img src="<?php echo $this->url;?>images/users/user-3.jpg" alt="user" class="profile-photo-md pull-left" />
                <div class="post-detail">
                  <div class="user-info">
                  ...
                  <div class="line-divider"></div>
                   <div class="post-comment">
                    <img src="<?php echo $this->url;?>images/users/user-14.jpg" alt="" class="profile-photo-sm" />
                  ...
                  <div class="post-comment">
                    <img src="<?php echo $this->url;?>images/users/user-2.jpg" alt="" class="profile-photo-sm" />
            ...
            <div class="post-content">
              <div class="post-container">
                <img src="<?php echo $this->url;?>images/users/user-2.jpg" alt="user" class="profile-photo-md pull-left" />
                <div class="post-detail">
                  <div class="user-info">
                  ...
                  <div class="line-divider"></div>
                  <div class="post-comment">
                    <img src="<?php echo $this->url;?>images/users/user-12.jpg" alt="" class="profile-photo-sm" />
            ...
            ================================================= -->
            <div class="post-content">
              <img src="<?php echo $this->url;?>images/post-images/2.jpg" alt="post-image" class="img-responsive post-image" />
              <div class="post-container">
                <img src="<?php echo $this->url;?>images/users/user-4.jpg" alt="user" class="profile-photo-md pull-left" />
                <div class="post-detail">
                  <div class="user-info">
                  ...
                  <div class="line-divider"></div>
                  <div class="post-comment">
                    <img src="<?php echo $this->url;?>images/users/user-13.jpg" alt="" class="profile-photo-sm" />
                  ...
                  <div class="post-comment">
                    <img src="<?php echo $this->url;?>images/users/user-8.jpg" alt="" class="profile-photo-sm" />
            ...
            ================================================= -->
            <div class="post-content">
              <img src="<?php echo $this->url;?>images/post-images/11.jpg" alt="" class="img-responsive post-image" />
              <div class="post-container">
                <img src="<?php echo $this->url;?>images/users/user-9.jpg" alt="user" class="profile-photo-md pull-left" />
                <div class="post-detail">
                  <div class="user-info">
                  ...
                  <div class="line-divider"></div>
                  <div class="post-comment">
                    <img src="<?php echo $this->url;?>images/users/user-10.jpg" alt="" class="profile-photo-sm" />
