            ...
            <div class="media">
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-1">
                      <video controls>
                        <source src="<?php echo$this->url;?>videos/3.mp4" type="video/mp4">
                      </video>
                    </div>
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-2">
                      <video controls>
                        <source src="<?php echo$this->url;?>videos/2.mp4" type="video/mp4">
                      </video>
                    </div>
                    <div class="media-info">
                      <div class="reaction">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-3">
                      <video controls>
                        <source src="<?php echo$this->url;?>videos/4.mp4" type="video/mp4">
                      </video>
                    </div>
                    <div class="media-info">
                      <div class="reaction">
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-4">
                      <video controls>
                        <source src="<?php echo$this->url;?>videos/5.mp4" type="video/mp4">
                      </video>
                    </div>
                    <div class="media-info">
                      <div class="reaction">
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-5">
                      <video controls>
                        <source src="<?php echo$this->url;?>videos/6.mp4" type="video/mp4">
                      </video>
                    </div>
                    <div class="media-info">
                      <div class="reaction">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-6">
                      <video controls>
                        <source src="<?php echo$this->url;?>videos/1.mp4" type="video/mp4">
                      </video>
                    </div>
                    <div class="media-info">
                      <div class="reaction">
                ...
                <div class="grid-item col-md-6 col-sm-6">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-7">
                      <video controls>
                        <source src="<?php echo$this->url; ?>videos/7.mp4" type="video/mp4">
                      </video>
                    </div>
                    <div class="media-info">
                      <div class="reaction">
